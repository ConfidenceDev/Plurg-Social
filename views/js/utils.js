...
const timer = document.querySelector(".ac_timer");
const profileImg = document.querySelector(".profile_img");
const profileName = document.querySelector(".ac_profile_name");
...
const postImage = document.querySelector(".post_img");
const postName = document.querySelector(".post_name");
const postFieldCount = document.querySelector(".post_field_count");
const postBio = document.querySelector(".post_bio");
const postURL = document.querySelector(".post_url");
